...
class SucLoginPage extends StatefulWidget {
  SucLoginPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _SucLoginPageState createState() => _SucLoginPageState();
}

class _SucLoginPageState extends State<SucLoginPage> {
